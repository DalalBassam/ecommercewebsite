	...
	if (isset($_SESSION['Username'])) {
		...
		if ($do == 'Manage') {
			...
			<div class="container categories">
							...
							foreach($cats as $cat) {
								echo "<div class='cat'>";
									echo "<div class='hidden-buttons'>";
										echo "<a href='categories.php?do=Edit&catid=" . $cat['ID'] . "' class='btn btn-xs'><i class='fa fa-edit'></i> Edit</a>";
										echo "<a href='categories.php?do=Delete&catid=" . $cat['ID'] . "' class='confirm btn btn-xs '><i class='fa fa-close'></i> Delete</a>";
									echo "</div>";
									echo "<h3>" . $cat['Name'] . '</h3>';
				...
				<a class="add-category btn " href="categories.php?do=Add"><i class="fa fa-plus"></i> Add New Category</a>
			</div>
				...
				<form class="form-horizontal" action="?do=Insert" method="POST">
					...
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10 col-md-6">
							<input type="text" name="name"  autocomplete="off" required="required"   class="form-control"      placeholder="Name Of The Category" />
						</div>
					</div>
					...
					<div class="form-group form-group-lg">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" value="Add Category" class="btn  btn-lg" />
						</div>
					</div>
					<!-- End Submit Field -->
				</form>
