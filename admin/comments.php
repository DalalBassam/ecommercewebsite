						...
						<?php
							foreach($comments as $comment) {
								echo "<tr>";
									...
									echo "<td>
										<a href='comments.php?do=Edit&comid=" . $comment['c_id'] . "' class='btn '><i class='fa fa-edit'></i> Edit</a>
										<a href='comments.php?do=Delete&comid=" . $comment['c_id'] . "' class='btn btn-dang confirm'><i class='fa fa-close'></i> Delete </a>";
										if ($comment['status'] == 0) {
